/*
  ...
  $                                                                                 $
  $  Ultima Compilacion: 16-07-2019.                        BOARD: ARDUINO UNO R3   $
  $                                                                                 $
  $                                                                                 $
  $                                                                                 $
  $---------------------------------------------------------------------------------$
...
void setup() {
  ...
  pinMode(2,OUTPUT);//led1 para temperatura
  pinMode(3,OUTPUT);//led2 para caidalibre
  ...
  pinMode(PinCaidaLibre, INPUT);
  digitalWrite(PinCaidaLibre,HIGH);
...
void loop() {
  Result1 = digitalRead(PinTemperatura);
  Result2 = digitalRead(PinCaidaLibre);
...
void serialEvent() {
  ...
  if (StringComplete == true) {
    if (InCommand.equals("1") == true || InCommand.equals("2") == true) {
      WaitConfirm == true;
      ExpCommand = InCommand;
    }//if incommand equals
    else if (InCommand.equals("3")) {
      ExpCommand = InCommand;
    }//else if
  }//if StringComplete == true
}//void serial Event
